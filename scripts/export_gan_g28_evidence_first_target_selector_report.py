#!/usr/bin/env python3
"""Export the Gan S0 G28 evidence-first target selector report."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export a Gan S0 G28 evidence-first target selector report."
    )
    parser.add_argument(
        "--g28-run",
        type=Path,
        required=True,
        help="Run directory for the completed G28 standard50 run.",
    )
    ...
    report = build_gan_g28_evidence_first_target_selector_report(
        g28_run_dir=args.g28_run,

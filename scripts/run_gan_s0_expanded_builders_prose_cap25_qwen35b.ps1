...
$experiment = "configs/experiments/gan_s0_expanded_builders_prose_cap25_qwen35b_ollama.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "gan_s0_expanded_builders_prose_cap25_qwen35b_$timestamp.log"
...
Write-Log "Gan S0 Qwen35b F0 expanded builders prose cap-25 run started"

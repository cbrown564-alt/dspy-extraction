#!/usr/bin/env python3
"""Export the Gan S0 G2 model-arm comparison report."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export a dual-scorer Gan S0 G2 model-arm comparison report."
    )
    ...
    report = build_gan_g2_model_arm_comparison_report(arm_run_dirs=arm_runs)
    write_report_artifacts(
        report,

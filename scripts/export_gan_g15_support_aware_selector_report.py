#!/usr/bin/env python3
"""Export the Gan S0 G15 support-aware target selector report."""
...
from clinical_extraction.evaluation.gan_g15_support_aware_selector import (
    ...
    build_gan_g15_support_aware_selector_report,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export a Gan S0 G15 support-aware selector report."
    )
    parser.add_argument(
        "--g15-run",
        type=Path,
        required=True,
        help="Run directory for the completed G15 standard50 run.",
    )
    ...
    report = build_gan_g15_support_aware_selector_report(
        g15_run_dir=args.g15_run,

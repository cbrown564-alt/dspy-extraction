#!/usr/bin/env python3
"""Export the Gan S0 G22 closed-option target selector report."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export a Gan S0 G22 closed-option target selector report."
    )
    parser.add_argument(
        "--g22-run",
        type=Path,
        required=True,
        help="Run directory for the completed G22 standard50 run.",
    )

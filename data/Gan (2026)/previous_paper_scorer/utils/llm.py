    ...
    while target_ids:
        ...
        if not output_file_id:  
            ...
            if llm_cache_path:
                ...
                for out in outputs:
                    llm_cache[str(out["body"]["messages"])] = out["predict"]
...
if __name__ == '__main__':
    ...
    # PYTHONPATH=/Users/yujiangan/Documents/python/KCL-Extractor  python /Users/yujiangan/Documents/python/KCL-Extractor/utils/llm.py
    submit_ChatGPTBatch()
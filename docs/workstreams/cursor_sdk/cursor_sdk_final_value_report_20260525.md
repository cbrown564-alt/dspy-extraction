...
| Core research-question synthesis source map | Helped locate and organize evidence for the Gan-vs-ExECT pipeline interpretation: Gan favors deterministic temporal candidates plus LLM adjudication; ExECT S1/S4 favors broad LLM extraction plus deterministic bridges. | `docs/experiments/synthesis/core_research_questions_pipeline_review_20260524.md` and `docs/experiments/synthesis/core_research_questions_experiment_source_index_20260524.md` |

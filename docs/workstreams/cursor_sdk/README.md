...
1. Use the promoted model compatibility backlog through `docs/policies/model_config_compatibility_backlog_20260524.md`, not the archived SDK report.
...
4. Keep remaining Gan, paper-synthesis, memory, and hygiene drafts archived unless a current source task explicitly reopens them.
...
6. Do not run cloud/PR experiments until there is a specific operational need and the same review-only boundary is preserved.

...
- `docs/workstreams/optimizer/dspy_optimizer_vs_manual_engineering_audit_20260520.md` (practice audit; partially superseded on ExECT compile path)
- `docs/workstreams/hybrid/hybrid_component_taxonomy_decision_20260520.md` (hybrid balance classes and intervention matrix)
- `docs/workstreams/optimizer/dspy_gepa_react_best_practices_deep_dive.md` (optimizer ladder guidance)
- `docs/experiments/exect/exect_s1_optimizer_gpt_cap25_v1_inspection_20260521.md` (latest ExECT optimizer pilot)
- `docs/planning/kanban_plan.md` (active tracker)
...
- Taxonomy schema: `docs/taxonomy/experiment_taxonomy_schema.md`, `hybrid_balance_class` definitions in `docs/workstreams/hybrid/hybrid_component_taxonomy_decision_20260520.md`
...
`docs/workstreams/optimizer/dspy_optimizer_vs_manual_engineering_audit_20260520.md` correctly noted that ExECT had no optimizer compile path. That gap was closed on 2026-05-21 with `compile_exect_s0_s1_module` and the ExECT S1 optimizer pilot. The audit's strategic conclusions otherwise remain largely valid.
...
Comparison group: `exect_s1_optimizer_gpt_cap25_v1`. Inspection: `docs/experiments/exect/exect_s1_optimizer_gpt_cap25_v1_inspection_20260521.md`.
...
Inspection: `docs/experiments/gan/gan_s0_few_shot_ladder_cap25_inspection_20260519.md`.
...
Decision: `docs/experiments/gan/gan_s0_gepa_vs_synthesis_decision_20260519.md`. Follow-up: `docs/experiments/gan/gan_s0_semantic_optimizer_cap25_followup_20260519.md`.
...
`docs/policies/qwen_dspy_latency_policy.md` excludes CoT + BootstrapFewShot + GEPA from routine Qwen work. Optimizer evidence is therefore concentrated on hosted GPT Gan paths and one ExECT pilot.
...
- Rungs 0–3 on validation: L0 **60.0%** → L1 **67.7%** → L1+policy **92.3%** full / **95.8%** cap-25 (`docs/experiments/exect/exect_s1_full_ladder_gpt_validation_v1_inspection_20260521.md`).
...
**What to run next:** comparison group `exect_s1_ladder_optimizer_automation_v1` — configs `exect_s1_full_ladder_l0_labeled_cap25`, `l0_bootstrap_cap25` (compile metric `exect_field_family_micro_f1_raw`), `l1_labeled_cap25`. Full prereg: `docs/experiments/exect/exect_s1_ladder_optimizer_automation_thesis_20260521.md`.
...
5. **Registry rows** — add one row per rung under a shared `comparison_group` in `docs/experiments/synthesis/experiment_registry.json`.
...
Qwen confirmation remains a separate track per `docs/planning/kanban_plan.md`: port only dev+test-confirmed arms.
...
| Doc | Relationship |
| --- | --- |
| `docs/workstreams/optimizer/dspy_optimizer_vs_manual_engineering_audit_20260520.md` | Extended; ExECT compile gap closed |
| `docs/workstreams/hybrid/hybrid_component_taxonomy_decision_20260520.md` | Ladder rungs instantiate `hybrid_balance_class` |
| `docs/workstreams/optimizer/dspy_gepa_react_best_practices_deep_dive.md` | Optimizer ordering guidance aligned with rungs 4–7 |

---

## Next Steps

See `docs/planning/kanban_plan.md` for tracker updates. Immediate engineering pulls:
...
3. Backfill ladder comparison group stub rows in `docs/experiments/synthesis/experiment_registry.json`.

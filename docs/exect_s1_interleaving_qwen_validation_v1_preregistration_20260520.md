...
Date: 2026-05-20  
Status: **Completed (GPT phase analogue)** — inspection `docs/exect_s1_interleaving_qwen_validation_v1_inspection_20260520.md`; matrix **reject port narrative**  
Comparison group: `exect_s1_interleaving_qwen_validation_v1`  
GPT reference: `exect_s1_interleaving_gpt_validation_v2` — `docs/exect_s1_interleaving_gpt_validation_v2_inspection_20260520.md`  
...
**Windows:** launch cap-25/full via external PowerShell or detached wrappers — not Cursor background shells (`docs/qwen_dspy_latency_policy.md`, experiment-run-lifecycle skill).

...
- **Cap-25 v2 gate**: `docs/gan_s0_verify_repair_cap25_v2_inspection_20260519.md`
...
Scorer: `gan_frequency_deterministic_v1` unchanged. Synthesis baseline figures are from the prior full-validation artifact documented in `docs/kanban_plan.md`.

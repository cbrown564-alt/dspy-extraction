...
Tracker card: `docs/planning/kanban_plan.md` → Backlog → **Consolidate experiment runner and program modules**
...
**Do not refactor** scorer semantics, split policy, or `gan_frequency_deterministic_v1` as part of this card — those remain single-threaded per `docs/planning/kanban_plan.md` dependency notes.

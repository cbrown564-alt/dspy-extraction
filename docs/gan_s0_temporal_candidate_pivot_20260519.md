...
- `docs/gan_s0_qwen_regression_slice_three_way_walkthrough_20260519.md`
- `docs/gan_s0_qwen35b_direct_cap25_guardrails_validation_error_analysis.md`
- `docs/gan_s0_qwen35b_verify_repair_regression_slice_guardrails_error_analysis.md`
- `docs/gan_s0_qwen35b_labeled_fewshot_regression_slice_guardrails_error_analysis.md`
- `docs/gan_s0_qwen35b_labeled_fewshot_verify_repair_regression_slice_guardrails_error_analysis.md`
- `docs/gan_s0_verify_repair_full_validation_v2_20260519.md`
- `docs/gan_s0_gepa_vs_synthesis_decision_20260519.md`
- `docs/gan_s0_few_shot_ladder_cap25_inspection_20260519.md`
- `docs/gan_s0_semantic_optimizer_cap25_followup_20260519.md`
- `docs/gan_s0_gemini31_flash_lite_full_validation_inspection_20260519.md`
- `docs/kanban_plan.md`

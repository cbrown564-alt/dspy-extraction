# Gan S0 Error Analysis: gan_s0_qwen35b_temporal_candidates_verify_repair_full_validation_guardrails

## Run

- Artifact directory: `runs\gan_s0_qwen35b_temporal_candidates_verify_repair_full_validation_guardrails_20260519T230324Z`
- Split: `gan_2026_fixed_v1:validation`
- Analysis scope: `full_split`
- Records in split: 299
- Records analyzed: 299
- Valid scored predictions: 298
...
| --- | ---: | ---: | ---: |
| normalized_label | 55.4% | 165 | 298 |
| monthly_frequency | 65.8% | 196 | 298 |
| purist_category | 75.5% | 225 | 298 |
| pragmatic_category | 82.6% | 246 | 298 |
...
- All-record denominator: 299 (valid scored: 298; invalid/missing: 1)
- Overall operational failure rate: 34.4% (103 failures)

| Stratum | All records | Valid scored | Operational failure rate | Monthly (valid only) |
| --- | ---: | ---: | ---: | ---: |
| hard_case=true | 39 | 38 | 28.2% | 73.7% |
| hard_case=false | 260 | 260 | 35.4% | 64.6% |
| row_ok=true | 287 | 286 | 35.9% | 64.3% |
| row_ok=false | 12 | 12 | 0.0% | 100.0% |
| gold_pragmatic=frequent | 152 | 151 | 40.8% | 59.6% |
| gold_pragmatic=infrequent | 51 | 51 | 49.0% | 51.0% |
| gold_pragmatic=no_seizure_information | 56 | 56 | 7.1% | 92.9% |
| gold_pragmatic=unknown | 40 | 40 | 30.0% | 70.0% |
...
- Gold label present in candidate set: 6/299 (2.0%)
...
| `gan_12950` | `7 per 3 month` | — | no |
| `gan_10047` | `2 cluster per 3 month, multiple per cluster` | — | no |
...
| `gan_15923` | `8 per 2 month` | — | no |
| `gan_467` | `9 per month` | — | no |
| `gan_2513` | `2 to 3 per 2 week` | — | no |
| `gan_10993` | `2 cluster per month, 2 to 4 per cluster` | — | no |
| `gan_14792` | `1 per month` | — | no |
...
| `gan_14821` | `1 per month` | — | no |
| `gan_6387` | `unknown` | — | no |
| `gan_10984` | `3 cluster per month, 3 to 4 per cluster` | — | no |
| `gan_8264` | `seizure free for 4 month` | — | no |
| `gan_14250` | `2 per month` | — | no |
| `gan_15876` | `6 per week` | — | no |
| `gan_1463` | `3 per month` | — | no |
| `gan_14689` | `3 per 2 month` | — | no |
...
| `gan_14214` | `2 to 4 per month` | — | no |
| `gan_3630` | `7 per week` | — | no |
| `gan_16753` | `19 per 6 month` | — | no |
| `gan_12667` | `1 per day` | — | no |
| `gan_15442` | `1 cluster per 4 day, 2 per cluster` | — | no |
...
| `gan_14137` | `unknown` | — | no |
| `gan_14973` | `1 per month` | — | no |
...
| `gan_13595` | `seizure free for multiple year` | — | no |
| `gan_12145` | `multiple per week` | — | no |
...
| `gan_12562` | `1 per day` | — | no |
| `gan_10031` | `1 cluster per week, multiple per cluster` | — | no |
...
| `gan_15404` | `1 cluster per 4 month, 3 to 4 per cluster` | — | no |
...
| `gan_8858` | `seizure free for multiple month` | — | no |
| `gan_8113` | `seizure free for 14 month` | — | no |
| `gan_14965` | `1 per 3 month` | — | no |
...
| `gan_2135` | `unknown` | — | no |
| `gan_14025` | `unknown` | — | no |
| `gan_9483` | `8 per 6 month` | — | no |
| `gan_3340` | `2 to 3 per month` | — | no |
| `gan_15255` | `multiple cluster per 15 month, multiple per cluster` | — | no |
...
| `gan_10673` | `1 cluster per month, multiple per cluster` | — | no |
| `gan_13058` | `2 per 7 month` | — | no |
...
| `gan_14271` | `2 to 3 per month` | — | no |
| `gan_13290` | `4 per 6 month` | — | no |
| `gan_6509` | `1 per week` | — | no |
| `gan_8116` | `seizure free for 12 month` | — | no |
| `gan_16645` | `5 per 7 month` | — | no |
...
| `gan_15168` | `multiple per 15 month` | — | no |
...
| `gan_16529` | `1 per 5 day` | — | no |
| `gan_6763` | `1 per week` | — | no |
| `gan_14092` | `unknown` | — | no |
| `gan_15302` | `1 to 2 per 14 month` | — | no |
...
| `gan_13149` | `3 per year` | `1 per year` | no |
| `gan_9109` | `unknown` | — | no |
...
| `gan_13190` | `1 per 5 month` | — | no |
| `gan_15240` | `multiple cluster per 12 month, multiple per cluster` | — | no |
| `gan_14562` | `3 per 6 month` | — | no |
...
| --- | --- | ---: | ---: |
| `1111` | all_four_match | 165 | 55.4% |
| `0000` | all_four_wrong | 52 | 17.4% |
| `0011` | purist_pragmatic_not_monthly | 29 | 9.7% |
| `0001` | pragmatic_only | 21 | 7.0% |
| `0111` | monthly_purist_pragmatic_not_normalized | 31 | 10.4% |

### Logical containment on this run

- Normalized exact (165 records): always co-occurs with monthly, Purist, and Pragmatic match.
- Monthly match (196 records): always implies Purist and Pragmatic; 165 also have normalized exact.
- Purist match (225 records): always implies Pragmatic; 196 also match monthly.
- Pragmatic-only wins (pattern `0001`): 21 records.
- Purist-without-monthly (pattern `0010`/`0011`): 0 + 29 records.

### Boundary cases

- **purist_bin_boundary_within_pragmatic**: 21
- **pragmatic_match_monthly_divergence**: 50
- **purist_match_monthly_divergence**: 29
- **monthly_match_label_surface_mismatch**: 31
...
| Failure class | Count |
| --- | ---: |
| other_semantic_mismatch | 24 |
| purist_bin_boundary_within_pragmatic | 21 |
| pragmatic_match_monthly_divergence | 19 |
| cluster_semantic_mismatch | 10 |
| cluster_collapsed_to_rate | 7 |
| frequent_undercalled | 7 |
| unknown_as_high_rate | 6 |
| unknown_as_quantified_rate | 3 |
| missed_frequency_reference | 2 |
...
The leading benchmark-severe failure class on this run is `other_semantic_mismatch` (24 scored misses). These are the first prompt or verifier targets; lower-tier metric wins should not hide them.

Cluster-format errors account for 22 scored misses, split between incomplete cluster labels (invalid), cluster structure swaps, and cluster collapsed to simple rates.

There are 21 **pragmatic-only** successes: same coarse bucket (infrequent vs frequent vs unknown vs no information) but wrong monthly value and Purist bin. These are clinically misleading if only Pragmatic accuracy is reported.

Purist-without-monthly cases: 29; pragmatic-without-monthly: 50. These arise when different labels land in the same bin but convert to different seizures/month.
...
| gan_16041 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 9 per 3 month | 10 per 3 month |
| gan_714 | scored | Y | Y | Y | Y | all_metrics_match | 2 per day | 2 per day |
| gan_12465 | scored | N | N | N | N | frequent_undercalled | 1 per day | 1 per year |
...
| gan_3867 | scored | N | N | N | N | other_semantic_mismatch | 3 per day | unknown |
| gan_15923 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 8 per 2 month | 7 per 2 month |
...
| gan_10993 | scored | N | N | Y | Y | cluster_semantic_mismatch | 2 cluster per month, 2 to 4 per cluster | 2 to 4 cluster per month, multiple per cluster |
| gan_14792 | scored | N | N | N | N | other_semantic_mismatch | 1 per month | unknown |
| gan_13574 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for years |
| gan_5974 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_6607 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_12438 | scored | N | N | N | N | other_semantic_mismatch | 1 per day | unknown |
...
| gan_14821 | scored | N | N | N | N | other_semantic_mismatch | 1 per month | unknown |
| gan_6387 | scored | N | N | N | N | unknown_as_quantified_rate | unknown | 2 per 3 month |
| gan_10984 | scored | N | N | Y | Y | cluster_semantic_mismatch | 3 cluster per month, 3 to 4 per cluster | 3 cluster per month, multiple per cluster |
| gan_8264 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 4 month | seizure free for 4 month |
| gan_14250 | scored | N | N | N | N | other_semantic_mismatch | 2 per month | unknown |
...
| gan_3623 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 7 per week | 1 cluster per week, multiple per cluster |
...
| gan_14214 | scored | N | N | N | N | other_semantic_mismatch | 2 to 4 per month | unknown |
| gan_3630 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 7 per week | 7 cluster per week, multiple per cluster |
| gan_16753 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 19 per 6 month | 10 per 6 month |
| gan_12667 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per day | 1 to 2 per month |
| gan_15442 | scored | N | N | N | N | cluster_collapsed_to_rate | 1 cluster per 4 day, 2 per cluster | unknown |
...
| gan_12218 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per day | 1 cluster per day, multiple per cluster |
...
| gan_14628 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 2 per 2 month | 2 per 3 month |
| gan_10996 | scored | N | N | Y | Y | cluster_semantic_mismatch | 1 to 2 cluster per month, 4 per cluster | 1 to 2 cluster per month, multiple per cluster |
| gan_16938 | scored | N | N | N | N | frequent_undercalled | 2 per week | 2 per 2 month |
| gan_14081 | scored | N | N | N | N | unknown_as_high_rate | unknown | 2 to 3 per 2 month |
...
| gan_9424 | scored | N | N | N | N | frequent_undercalled | 10 per 9 month | 1 per month |
...
| gan_7818 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 2 year | seizure free for 2 years |
| gan_13598 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for n unit |
| gan_14137 | scored | N | N | N | N | unknown_as_high_rate | unknown | 3 to 4 per 3 month |
| gan_14973 | scored | N | N | N | N | other_semantic_mismatch | 1 per month | unknown |
...
| gan_13595 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for years |
...
| gan_6094 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 3 per month | 5 cluster per month, multiple per cluster |
| gan_2824 | scored | Y | Y | Y | Y | all_metrics_match | 1 per day | 1 per day |
| gan_7872 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 month |
| gan_1486 | scored | Y | Y | Y | Y | all_metrics_match | 3 per month | 3 per month |
| gan_7431 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per month | 2 per 8 week |
...
| gan_3864 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 3 per day | multiple cluster per week, multiple per cluster |
| gan_5551 | scored | Y | Y | Y | Y | all_metrics_match | multiple per day | multiple per day |
| gan_8160 | scored | N | N | N | N | other_semantic_mismatch | seizure free for multiple month | unknown |
...
| gan_338 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | multiple per month | multiple per week |
| gan_12562 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per day | 4 per week |
| gan_10031 | scored | N | N | N | N | cluster_collapsed_to_rate | 1 cluster per week, multiple per cluster | unknown |
...
| gan_4996 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for 16 month | seizure free for 1 year |
| gan_3261 | scored | N | N | Y | Y | cluster_semantic_mismatch | 2 cluster per month, 4 per cluster | 2 cluster per month, multiple per cluster |
| gan_15513 | scored | N | N | Y | Y | cluster_semantic_mismatch | 1 cluster per 4 to 5 day, 2 to 3 per cluster | 1 cluster per week, multiple per cluster |
...
| gan_6077 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
...
| gan_7882 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 6 month | seizure free for 6 months |
...
| gan_3113 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 14 month | seizure free for 14 months |
| gan_5197 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 months |
| gan_12319 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 2 to 3 per week | 2 to 3 cluster per week, multiple per cluster |
| gan_6624 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_4602 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per 7 to 10 day | 1 per 7 day |
| gan_5977 | scored | N | N | N | N | unknown_as_high_rate | unknown | multiple per 6 week |
...
| gan_4831 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 months |
| gan_9179 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 months |
...
| gan_13487 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple year | no seizure frequency reference |
| gan_8858 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 15 month |
| gan_8113 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 14 month | seizure free for 14 month |
| gan_14965 | scored | N | N | N | N | other_semantic_mismatch | 1 per 3 month | unknown |
...
| gan_13416 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for 6 month |
| gan_11196 | scored | N | N | Y | Y | cluster_semantic_mismatch | 3 cluster per month, 5 per cluster | 3 cluster per month, multiple per cluster |
...
| gan_5379 | scored | N | N | N | N | other_semantic_mismatch | seizure free for multiple month | unknown |
...
| gan_16750 | scored | N | N | N | N | other_semantic_mismatch | 6 per 7 month | unknown |
| gan_15127 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 5 per 13 month | 4 per 13 month |
...
| gan_16523 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per 5 day | 1 cluster per 5 day, multiple per cluster |
| gan_7884 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
...
| gan_14025 | scored | N | N | N | N | unknown_as_quantified_rate | unknown | 2 per 3 month |
...
| gan_15255 | scored | N | N | N | N | cluster_collapsed_to_rate | multiple cluster per 15 month, multiple per cluster | unknown |
| gan_8852 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 8 month | seizure free for 8 month |
| gan_7783 | scored | N | N | N | N | other_semantic_mismatch | seizure free for multiple month | unknown |
...
| gan_10673 | scored | N | N | N | N | cluster_collapsed_to_rate | 1 cluster per month, multiple per cluster | unknown |
| gan_13058 | scored | N | N | N | N | other_semantic_mismatch | 2 per 7 month | unknown |
| gan_2369 | scored | Y | Y | Y | Y | all_metrics_match | 3 to 4 per month | 3 to 4 per month |
| gan_8224 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
...
| gan_744 | scored | Y | Y | Y | Y | all_metrics_match | multiple per week | multiple per week |
| gan_4591 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per 5 month | 2 per 18 month |
| gan_14271 | scored | N | N | N | N | other_semantic_mismatch | 2 to 3 per month | unknown |
...
| gan_16645 | scored | N | N | N | N | other_semantic_mismatch | 5 per 7 month | unknown |
...
| gan_8474 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
| gan_3291 | scored | Y | Y | Y | Y | all_metrics_match | 9 per month | 9 per month |
| gan_15193 | scored | N | N | N | N | other_semantic_mismatch | multiple per 13 month | unknown |
| gan_16574 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per 4 day | 1 cluster per 4 day, multiple per cluster |
...
| gan_14390 | scored | N | N | N | N | other_semantic_mismatch | 2 per 3 month | unknown |
...
| gan_6153 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 9 per month | 10 per 4 week |
...
| gan_14036 | scored | N | N | N | N | unknown_as_high_rate | unknown | 4 per 3 month |
...
| gan_5866 | invalid | - | - | - | - | invalid_predicted_label | 4 per 6 week | 4 per 6 week, multiple per cluster |
...
| gan_8844 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 15 month | seizure free for 15 months |
...
| gan_8723 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 month |
| gan_16529 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per 5 day | 1 cluster per 5 day, multiple per cluster |
...
| gan_15302 | scored | N | N | N | N | other_semantic_mismatch | 1 to 2 per 14 month | unknown |
| gan_5837 | scored | N | N | Y | Y | cluster_semantic_mismatch | 2 cluster per 3 week, multiple per cluster | 2 cluster per week, multiple per cluster |
...
| gan_7420 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 to 2 per 2 week | 1 to 2 cluster per week, multiple per cluster |
| gan_2354 | scored | Y | Y | Y | Y | all_metrics_match | 6 to 7 per week | 6 to 7 per week |
| gan_11399 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_11733 | scored | Y | Y | Y | Y | all_metrics_match | no seizure frequency reference | no seizure frequency reference |
| gan_13149 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 3 per year | 1 per year |
| gan_9109 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_3118 | scored | N | N | N | N | other_semantic_mismatch | seizure free for multiple month | unknown |
...
| gan_4992 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for 11 month | seizure free for 1 year |
| gan_2366 | scored | Y | Y | Y | Y | all_metrics_match | 2 to 4 per year | 2 to 4 per year |
| gan_5082 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
| gan_9526 | scored | N | N | N | N | frequent_overcalled | 4 per 8 month | 20 per 8 month |
| gan_8893 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 4 month |
| gan_8645 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 months |
| gan_11035 | scored | Y | Y | Y | Y | all_metrics_match | 1 cluster per 3 month, 1 per cluster | 1 cluster per 3 month, 1 per cluster |
| gan_8002 | scored | Y | Y | Y | Y | all_metrics_match | 1 per 6 to 8 week | 1 per 6 to 8 week |
| gan_13190 | scored | N | N | N | N | other_semantic_mismatch | 1 per 5 month | unknown |
| gan_15240 | scored | N | N | N | N | cluster_collapsed_to_rate | multiple cluster per 12 month, multiple per cluster | unknown |
| gan_14562 | scored | N | N | N | N | other_semantic_mismatch | 3 per 6 month | unknown |

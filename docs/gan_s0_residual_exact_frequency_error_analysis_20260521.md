...
- `docs/gan_s0_exact_frequency_residual_manual_read_20260521.md`
...
This analysis follows `docs/gan_2026_label_audit.md` and `docs/deterministic_scorer_semantics.md`:
...
2. **Run an error-read on ~30 representative records** before any new model calls:
   ...
   Status: exported as `docs/gan_s0_exact_frequency_residual_slice_error_read_20260521.md`.

...
Design context: `docs/exect_s2_s4_schema_ladder_design.md`, `docs/exect_s3_phase1_overlap_policy.md`
...
Overlap policy (`docs/exect_s3_phase1_overlap_policy.md`) is working as designed at scorer level; extraction assigns phrases to wrong families or non-canonical surfaces.

...
**Superseded for active planning by:** `docs/planning/research_drift_audit_20260520.md` (hosted ExECT ladder frozen; Qwen replication; Gan Tier 1 signed)  
...
1. **Core direction documents**
   ...
   - `docs/planning/kanban_plan.md` — active tracker, dual-track map, gates
   - `docs/policies/deterministic_foundation_decisions.md` — infrastructure-first policy
   - `docs/planning/research_status_recap_20260519.md` — narrative synthesis
   - `docs/experiments/gan/gan_s0_temporal_candidates_v1_1_full_validation_decision_20260519.md` — pre-registered Gan promotion tiers
   - `docs/experiments/gan/gan_s0_temporal_candidate_pivot_20260519.md` — pivot rationale
   - `docs/experiments/exect/exect_s0_label_policy_v4_2_implementation.md` — ExECT v4.2 anchor
...
The project operates on **two parallel tracks** (see `docs/planning/kanban_plan.md` § Execution Model). They share deterministic infrastructure but differ in model, latency, and promotion gates:
...
| **B** ExECT diagnosis-recall probe | 14-record slice | **Negative — closed** | `…202910Z`; `docs/experiments/exect/exect_s0_s1_diagnosis_recall_probe_inspection_20260519.md` |
...
**Beat published benchmarks.** Published Gan Purist micro-F1 is ~0.77–0.79 on Real(300); in-repo best hosted monthly is 65.4%. Gap expected until scorer alignment and real-letter data exist (`docs/policies/published_benchmark_metrics.md`).
...
**Gan engineering fork (B1/B2/ReAct/hosted port).** Blocked on tier decision per `docs/experiments/gan/gan_s0_temporal_candidates_v1_1_full_validation_decision_20260519.md`.

### Useful detours (evidence-backed, now closed or deprioritized)

| Detour | Outcome | Decision artifact |
| --- | --- | --- |
| GEPA + semantic optimizers | Rejected for scale-up | `docs/experiments/gan/gan_s0_gepa_vs_synthesis_decision_20260519.md` |
| Few-shot / LabeledFewShot ladders | Did not clear infrequent gate | `docs/experiments/gan/gan_s0_few_shot_ladder_cap25_inspection_20260519.md` |
| Qwen token budget 256→1024 | No metric improvement | `docs/workstreams/optimizer/qwen_local_latency_experiment_20260518.md` |
| Gemini Flash-Lite probes | Weaker evidence vs GPT verify-repair | `docs/experiments/gan/gan_s0_gemini31_flash_lite_full_validation_inspection_20260519.md` |
| ExECT section-aware ablation | Regressed vs monolithic on cap-25 | `docs/experiments/exect/exect_section_aware_cap25_inspection.md` |
| ExECT diagnosis-recall add-only pass | Recall flat; precision collapsed | `docs/experiments/exect/exect_s0_s1_diagnosis_recall_probe_inspection_20260519.md` |
...
An earlier version of `docs/experiments/gan/gan_s0_temporal_candidates_v1_1_full_validation_decision_20260519.md` listed “ExECT cap-25 only” until the Gan tier was signed. The May 19 sprint then completed:
...
4. **Kanban updated** — `docs/planning/kanban_plan.md` now documents Track A / Track B explicitly; the cap-25-only note in the promotion decision doc is **superseded for planning** by kanban (decision doc tier gates for **Gan B1/B2/ReAct** remain valid).
...
`docs/planning/research_status_recap_20260519.md` may still overweight GEPA as an open question; refresh after Gan tier decision. Kanban dual-track section is now authoritative for **what to do next**.
...
1. Run promotion packet A–F per `docs/experiments/gan/gan_s0_temporal_candidates_v1_1_full_validation_decision_20260519.md`.
...
- `docs/planning/research_status_recap_20260519.md`
- `docs/experiments/gan/gan_s0_temporal_candidate_pivot_20260519.md`
- `docs/experiments/gan/gan_s0_temporal_candidates_v1_1_full_validation_decision_20260519.md`
- `docs/experiments/exect/exect_s0_label_policy_v4_2_implementation.md`
- `docs/experiments/exect/exect_s0_s1_diagnosis_recall_probe_inspection_20260519.md`
- `docs/experiments/exect/exect_s0_label_policy_regression_slice_comparison_20260519.md`

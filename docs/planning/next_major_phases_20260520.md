...
Related: `docs/planning/kanban_plan.md`, `docs/experiments/exect/exect_negative_probe_synthesis_20260520.md`, `docs/taxonomy/taxonomy_primitive_coverage_audit_20260520.md`, `docs/experiments/exect/exect_field_family_deterministic_support_map_20260520.md`, `docs/taxonomy/taxonomy_primitives_workstream_plan_20260520.md`, `docs/taxonomy/experiment_taxonomy_research_synthesis_20260520.md`
...
- A negative-probe synthesis note covering the closed ExECT arms: `docs/experiments/exect/exect_negative_probe_synthesis_20260520.md`.
- Primitive coverage audit that labels implemented primitives as `promoted`, `diagnostic_only`, `rejected_for_current_arm`, `planned`, or `blocked`: `docs/taxonomy/taxonomy_primitive_coverage_audit_20260520.md`.

...
Prior audit: `docs/planning/research_drift_audit_20260519.md` (May 19 dual-track refresh)  
Frozen-thread anchors: `docs/planning/kanban_frozen_threads_history.md`  
...
1. **Core direction documents**
   ...
   - `docs/planning/kanban_plan.md` — active tracker (refreshed 2026-05-20)
   - `docs/planning/kanban_frozen_threads_history.md` — frozen Threads A–E
   - `docs/experiments/exect/exect_qwen35b_ladder_replication_plan.md` — Qwen replication gates
   - `docs/planning/research_drift_audit_20260519.md` — prior verdict and risks
...
The project operates on **three coordinated threads** (see `docs/planning/kanban_plan.md` § Execution Model):
...
**Do not compare across tracks as one experiment.** Same deterministic scorers within each dataset; anchors documented per track in `docs/planning/kanban_frozen_threads_history.md`.
...
**Hosted GPT for rapid iteration; Qwen for local deployment.** ExECT label-policy micro-iteration on hosted GPT is **stopped** at frozen ladder versions; active ExECT model work is replication-only on Qwen per `docs/experiments/exect/exect_qwen35b_ladder_replication_plan.md`.
...
**Continue (in order)** — aligned with `docs/planning/kanban_plan.md` grill sync 2026-05-20:
...
- `docs/experiments/exect/exect_qwen35b_ladder_replication_plan.md`
- `docs/policies/deterministic_foundation_decisions.md`
- `docs/policies/deterministic_scorer_semantics.md`

### Prior audit

- `docs/planning/research_drift_audit_20260519.md`

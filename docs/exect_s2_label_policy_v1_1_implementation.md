...
Cap-25 error read (`docs/exect_s2_validation_cap25_gpt4_1_mini_inspection_20260519.md`) showed seizure F1 collapse (40% vs 95.4% S1 cap-25) from model output drift when S2 fields were added, not from changes to frozen S1 bridges.

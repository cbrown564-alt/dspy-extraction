...
Pre-registration: `docs/experiments/exect/exect_s4_temporality_deterministic_preregistration_20260520.md`
...
3. Optional: planned/taper phrase slice error-read to diagnose full-validation recall collapse before any classifier retune. **Done:** `docs/experiments/exect/exect_s4_temporality_planned_taper_error_read_20260520.md`

...
Inspection anchor: `docs/experiments/exect/exect_s4_temporality_deterministic_gpt_inspection_20260520.md`  
...
- Gold: medication temporality inferred from annotated Prescription span text (`docs/experiments/exect/exect_s4_gold_policy.md`)
...
2. Keep L1 frozen as ExECT S4 GPT default (`docs/planning/kanban_plan.md`).

...
**S2 frozen.** Schema ladder proceeds at this baseline — see `docs/experiments/exect/exect_s2_s4_schema_ladder_design.md` and Thread D in `docs/planning/kanban_plan.md`.

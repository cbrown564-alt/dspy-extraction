...
Cap-25 v1.1 (`runs/exect_s2_validation_cap25_gpt4_1_mini_20260519T225159Z`) cleared the seizure gate (80.6% F1) but **comorbidity remained the main gap** (53.8% F1, 50% recall). Error read: `docs/experiments/exect/exect_s2_validation_cap25_gpt4_1_mini_inspection_20260519.md`.
...
Error read: `docs/experiments/exect/exect_s2_validation_full_gpt4_1_mini_inspection_20260520.md`

...
Error read: `docs/experiments/exect/exect_s4_validation_full_v1_1_gpt4_1_mini_inspection_20260520.md`.
...
**Read:** v1.2 investigation guard delivers **+10.5pp** full investigation F1 without frequency regression (+0.5pp). **Freeze at v1.2** — error read: `docs/experiments/exect/exect_s4_validation_full_v1_2_gpt4_1_mini_inspection_20260520.md`.

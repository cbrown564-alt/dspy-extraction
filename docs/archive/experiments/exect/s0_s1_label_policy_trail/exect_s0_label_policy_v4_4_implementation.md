...
See `docs/experiments/exect/exect_label_policy_prior_error_analysis_traceability_20260519.md` for reconciliation of this ladder with `docs/archive/prior-context/previous_exect_error_analysis.md` (audited-gold pivot, §8 canonical cases, and regression-slice gaps).

## Next

- **v4.5 bounded hypotheses** (see `docs/experiments/exect/exect_s0_s1_validation_full_v4_4_inspection.md`): JME/GTCS vs myoclonic surfaces; note-gated generic `epilepsy` co-list; EA0008 medication; EA0188 specificity-collapse co-list
- Slice expanded **23 → 37 records** (`exect_s0_label_policy_regression_v3`); re-run slice config before v4.5 work

## Prior analysis traceability

See `docs/experiments/exect/exect_label_policy_prior_error_analysis_traceability_20260519.md` and `docs/experiments/exect/exect_s0_s1_validation_full_v4_4_inspection.md`.

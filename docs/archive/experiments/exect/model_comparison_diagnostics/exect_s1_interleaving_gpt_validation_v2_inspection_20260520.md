...
1. ~~Run medication-only slice pair~~ — complete; see `docs/experiments/exect/exect_s1_medication_pre_vocab_slice_gpt_inspection_20260520.md`.
2. ~~Add registry rows for v2 runs~~ — complete in `docs/experiments/synthesis/experiment_registry.json`.

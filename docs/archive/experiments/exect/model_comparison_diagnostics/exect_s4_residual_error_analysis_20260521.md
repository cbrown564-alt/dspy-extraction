...
This analysis follows `docs/datasets/exect/exect_gold_label_audit.md`, `docs/experiments/exect/exect_s4_gold_policy.md`, and `docs/policies/deterministic_scorer_semantics.md`.

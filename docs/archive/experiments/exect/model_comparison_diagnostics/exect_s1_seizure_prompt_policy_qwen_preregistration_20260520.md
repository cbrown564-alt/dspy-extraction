...
Error analysis: `docs/experiments/exect/exect_qwen_s1_seizure_gap_error_analysis_20260520.md`  
Preregistration chain: `docs/experiments/exect/exect_qwen_s1_seizure_gap_error_analysis_preregistration_20260520.md`
...
- Do not add a separate secondary generalised tonic-clonic type unless the letter names **multiple current seizure types** (re-anchor `docs/archive/prior-context/previous_exect_error_analysis.md` §7.1).
...
1. Implement `exect_s0_s1_field_family_v4_11_label_policy` + `docs/experiments/exect/exect_s0_label_policy_v4_11_implementation.md`.
...
6. Re-run `scripts/analyze_exect_qwen_s1_seizure_gap_error_read.py` on treatment full vs frozen baseline; write inspection `docs/experiments/exect/exect_s1_seizure_prompt_policy_qwen_v1_inspection_20260520.md` (date suffix updated on completion).
7. Registry rows under `exect_s1_seizure_prompt_policy_qwen_v1`.

**Windows:** launch model runs via external PowerShell or detached wrappers — not Cursor background shells (`docs/policies/qwen_dspy_latency_policy.md`).
...
Inspection: `docs/experiments/exect/exect_s1_seizure_prompt_policy_qwen_v1_inspection_20260520.md`  
...
| Artifact | Path |
| --- | --- |
| Implementation log | `docs/experiments/exect/exect_s0_label_policy_v4_11_implementation.md` |
| Inspection | `docs/exect_s1_seizure_prompt_policy_qwen_v1_inspection_<date>.md` |
| Registry rows | `docs/experiments/synthesis/experiment_registry.json` under `exect_s1_seizure_prompt_policy_qwen_v1` |
| Kanban | Update `docs/planning/kanban_plan.md` active work / decisions |

## Validation (pre-run)

- [ ] `v4_11` prompt diff reviewed against `docs/datasets/exect/exect_gold_label_audit.md` and `docs/archive/prior-context/previous_exect_error_analysis.md`

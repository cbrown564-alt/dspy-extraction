...
Date: 2026-05-20  
Preregistration: `docs/experiments/exect/exect_qwen_s1_seizure_gap_error_analysis_preregistration_20260520.md`  
...
These align with `docs/archive/prior-context/previous_exect_error_analysis.md`: models split or collapse secondary generalisation differently than the audited benchmark policy. GPT still errs on some shared docs, but with far fewer atoms overall.

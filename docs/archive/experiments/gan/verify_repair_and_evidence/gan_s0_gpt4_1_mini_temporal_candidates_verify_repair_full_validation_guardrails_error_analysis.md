...
| --- | ---: | ---: | ---: |
| normalized_label | 52.3% | 156 | 298 |
| monthly_frequency | 65.1% | 194 | 298 |
| purist_category | 76.5% | 228 | 298 |
| pragmatic_category | 84.2% | 251 | 298 |
...
- Overall operational failure rate: 35.1% (105 failures)

| Stratum | All records | Valid scored | Operational failure rate | Monthly (valid only) |
| --- | ---: | ---: | ---: | ---: |
| hard_case=true | 39 | 39 | 28.2% | 71.8% |
| hard_case=false | 260 | 259 | 36.2% | 64.1% |
| row_ok=true | 287 | 286 | 36.2% | 64.0% |
| row_ok=false | 12 | 12 | 8.3% | 91.7% |
| gold_pragmatic=frequent | 152 | 151 | 37.5% | 62.9% |
| gold_pragmatic=infrequent | 51 | 51 | 56.9% | 43.1% |
| gold_pragmatic=no_seizure_information | 56 | 56 | 1.8% | 98.2% |
| gold_pragmatic=unknown | 40 | 40 | 45.0% | 55.0% |
...
| --- | --- | ---: | ---: |
| `0011` | purist_pragmatic_not_monthly | 34 | 11.4% |
| `0111` | monthly_purist_pragmatic_not_normalized | 38 | 12.8% |
| `0000` | all_four_wrong | 47 | 15.8% |
| `1111` | all_four_match | 156 | 52.3% |
| `0001` | pragmatic_only | 23 | 7.7% |

### Logical containment on this run

- Normalized exact (156 records): always co-occurs with monthly, Purist, and Pragmatic match.
- Monthly match (194 records): always implies Purist and Pragmatic; 156 also have normalized exact.
- Purist match (228 records): always implies Pragmatic; 194 also match monthly.
- Pragmatic-only wins (pattern `0001`): 23 records.
- Purist-without-monthly (pattern `0010`/`0011`): 0 + 34 records.

### Boundary cases

- **purist_bin_boundary_within_pragmatic**: 23
- **pragmatic_match_monthly_divergence**: 57
- **purist_match_monthly_divergence**: 34
- **monthly_match_label_surface_mismatch**: 38
...
| Failure class | Count |
| --- | ---: |
| pragmatic_match_monthly_divergence | 31 |
| purist_bin_boundary_within_pragmatic | 20 |
| other_semantic_mismatch | 11 |
| unknown_as_high_rate | 10 |
| frequent_undercalled | 8 |
| cluster_semantic_mismatch | 7 |
| cluster_collapsed_to_rate | 5 |
| frequent_overcalled | 4 |
| unknown_as_quantified_rate | 4 |
...
| unknown_as_high_rate | 10 |
| frequent_undercalled | 8 |
| cluster_semantic_mismatch | 5 |
| cluster_collapsed_to_rate | 4 |
| frequent_overcalled | 4 |
| unknown_as_quantified_rate | 4 |
| unknown_vs_seizure_free | 2 |
| cluster_structure_swap | 1 |
...
The leading benchmark-severe failure class on this run is `pragmatic_match_monthly_divergence` (31 scored misses). These are the first prompt or verifier targets; lower-tier metric wins should not hide them.

Cluster-format errors account for 17 scored misses, split between incomplete cluster labels (invalid), cluster structure swaps, and cluster collapsed to simple rates.

There are 23 **pragmatic-only** successes: same coarse bucket (infrequent vs frequent vs unknown vs no information) but wrong monthly value and Purist bin. These are clinically misleading if only Pragmatic accuracy is reported.

Purist-without-monthly cases: 34; pragmatic-without-monthly: 57. These arise when different labels land in the same bin but convert to different seizures/month.
...
| gan_10434 | scored | N | N | N | N | cluster_collapsed_to_rate | multiple cluster per week, 2 to 3 per cluster | unknown |
...
| gan_4702 | scored | N | N | N | N | other_semantic_mismatch | multiple per day | unknown |
...
| gan_1794 | scored | Y | Y | Y | Y | all_metrics_match | 8 per 2 month | 8 per 2 month |
| gan_10618 | scored | N | N | N | N | cluster_structure_swap | unknown, 4 to 6 per cluster | 1 cluster per day, 4 to 6 per cluster |
...
| gan_4113 | scored | Y | Y | Y | Y | all_metrics_match | 1 per 1 to 2 day | 1 per 1 to 2 day |
...
| gan_15997 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 10 per 3 month | 6 per 2 month |
...
| gan_16772 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 9 per 5 month | 8 per 4 month |
| gan_16825 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 10 per 6 month | 6 per 3 month |
...
| gan_16041 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 9 per 3 month | 7 per 3 month |
...
| gan_10993 | scored | N | N | N | Y | cluster_semantic_mismatch | 2 cluster per month, 2 to 4 per cluster | 1 cluster per month, 2 to 4 per cluster |
...
| gan_6387 | scored | N | N | N | N | unknown_as_quantified_rate | unknown | 2 per year |
| gan_10984 | scored | N | N | N | Y | cluster_semantic_mismatch | 3 cluster per month, 3 to 4 per cluster | 1 cluster per month, 3 to 4 per cluster |
| gan_8264 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 4 month | seizure free for 4 month |
| gan_14250 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 2 per month | 2 per week |
...
| gan_14689 | scored | N | N | N | N | frequent_undercalled | 3 per 2 month | 1 to 3 per 2 month |
| gan_4100 | scored | Y | Y | Y | Y | all_metrics_match | 1 per 2 to 3 week | 1 per 2 to 3 week |
...
| gan_3623 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 7 per week | multiple per week |
...
| gan_14214 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 2 to 4 per month | 1 to 4 per month |
| gan_3630 | scored | N | N | N | N | other_semantic_mismatch | 7 per week | unknown |
| gan_16753 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 19 per 6 month | 5 per month |
| gan_12667 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per day | 2 per month |
| gan_15442 | scored | N | N | N | Y | cluster_semantic_mismatch | 1 cluster per 4 day, 2 per cluster | 1 cluster per day, 2 per cluster |
...
| gan_14081 | scored | N | N | N | N | unknown_as_high_rate | unknown | 2 to 3 per month |
| gan_6131 | scored | N | N | N | N | unknown_as_quantified_rate | unknown | 1 per year |
| gan_10509 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_14354 | scored | N | N | N | N | frequent_overcalled | 2 to 4 per 3 month | 2 to 4 per month |
...
| gan_7818 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for 2 year | seizure free for 1 year |
| gan_13598 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for years |
...
| gan_12296 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 3 to 4 per day | 4 per day |
...
| gan_12145 | scored | N | N | N | N | frequent_undercalled | multiple per week | 3 per year |
| gan_3300 | scored | N | Y | Y | Y | monthly_match_label_surface_mismatch | 9 per month | 9 per 30 day |
| gan_6094 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 3 per month | 5 per month |
...
| gan_8160 | scored | N | N | N | N | other_semantic_mismatch | seizure free for multiple month | 1 per 3 week |
...
| gan_338 | invalid | - | - | - | - | invalid_predicted_label | multiple per month | many per month |
...
| gan_15513 | scored | Y | Y | Y | Y | all_metrics_match | 1 cluster per 4 to 5 day, 2 to 3 per cluster | 1 cluster per 4 to 5 day, 2 to 3 per cluster |
...
| gan_14655 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 2 per 2 month | 1 per 3 month |
| gan_15404 | scored | N | N | N | N | cluster_semantic_mismatch | 1 cluster per 4 month, 3 to 4 per cluster | 1 cluster per day, 3 to 4 per cluster |
...
| gan_12319 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 2 to 3 per week | 3 per week |
| gan_6624 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_4602 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per 7 to 10 day | 1 per week |
| gan_5977 | scored | N | N | N | N | unknown_as_high_rate | unknown | 2 per 6 week |
...
| gan_9179 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
...
| gan_13416 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple year | seizure free for year |
...
| gan_4700 | scored | N | N | N | N | other_semantic_mismatch | multiple per day | unknown |
...
| gan_15129 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 4 per 15 month | 4 per year |
...
| gan_9943 | scored | N | N | Y | Y | cluster_semantic_mismatch | 1 cluster per 4 to 5 week, multiple per cluster | 1 cluster per month, multiple per cluster |
| gan_16750 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 6 per 7 month | 4 per 6 month |
| gan_15127 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 5 per 13 month | 5 per year |
...
| gan_8577 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 1 year |
...
| gan_9483 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 8 per 6 month | 1 to 2 per month |
| gan_3340 | scored | Y | Y | Y | Y | all_metrics_match | 2 to 3 per month | 2 to 3 per month |
| gan_15255 | scored | N | N | N | N | cluster_semantic_mismatch | multiple cluster per 15 month, multiple per cluster | 1 cluster per week, multiple per cluster |
...
| gan_13058 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 2 per 7 month | 1 per 7 week |
...
| gan_744 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | multiple per week | 1 per 5 day |
...
| gan_13290 | scored | N | N | N | N | frequent_overcalled | 4 per 6 month | 2 per 3 week |
...
| gan_16645 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 5 per 7 month | 1 cluster per 6 month, 3 per cluster |
| gan_3102 | scored | Y | Y | Y | Y | all_metrics_match | seizure free for 14 month | seizure free for 14 month |
| gan_9002 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 7 per year | 1 per month |
...
| gan_3291 | scored | N | Y | Y | Y | monthly_match_label_surface_mismatch | 9 per month | 9 per 30 day |
| gan_15193 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | multiple per 13 month | 1 per month |
...
| gan_6153 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 9 per month | 3 per month |
...
| gan_14036 | scored | N | N | N | N | unknown_as_high_rate | unknown | 4 per month |
| gan_7290 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_13019 | scored | Y | Y | Y | Y | all_metrics_match | 9 per 3 month | 9 per 3 month |
...
| gan_10074 | scored | N | N | Y | Y | cluster_semantic_mismatch | 5 cluster per month, multiple per cluster | 1 cluster per month, 5 per cluster |
| gan_750 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | multiple per week | 1 to 2 per week |
| gan_14076 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_8844 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for 15 month | seizure free for 1 year |
| gan_15168 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | multiple per 15 month | 1 per month |
...
| gan_8723 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 1 month |
...
| gan_15302 | scored | N | N | N | N | frequent_overcalled | 1 to 2 per 14 month | 1 to 2 per month |
...
| gan_1694 | scored | N | N | Y | Y | cluster_collapsed_to_rate | 1 cluster per 2 week, 3 per cluster | 3 per 14 day |
| gan_5954 | scored | Y | Y | Y | Y | all_metrics_match | 2 per week | 2 per week |
| gan_16422 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per 2 to 3 day | 1 per 2 day |
...
| gan_7420 | scored | N | N | N | N | frequent_undercalled | 1 to 2 per 2 week | 2 per 3 month |
...
| gan_13149 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 3 per year | 1 per 3 month |
| gan_9109 | scored | Y | Y | Y | Y | all_metrics_match | unknown | unknown |
| gan_3118 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 6 month |
...
| gan_9526 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 4 per 8 month | 2 per 6 month |
| gan_8893 | scored | N | Y | Y | Y | seizure_free_label_shape_mismatch | seizure free for multiple month | seizure free for 4 month |
| gan_8645 | scored | N | Y | Y | Y | seizure_free_to_no_reference_monthly_match | seizure free for multiple month | no seizure frequency reference |
...
| gan_13190 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 1 per 5 month | 1 per 3 month |
| gan_15240 | scored | N | N | N | N | cluster_collapsed_to_rate | multiple cluster per 12 month, multiple per cluster | unknown |
| gan_14562 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 3 per 6 month | 3 per 7 month |

...
- Next Thread B step: **breadth pivot** (S2 field expansion, architecture ablation at fixed S1, or benchmark-reproduction infra) — see `docs/kanban_plan.md`.
...
`docs/exect_s0_label_policy_v4_9_implementation.md`, `docs/exect_s0_s1_validation_full_v4_4_inspection.md`, `docs/exect_label_policy_prior_error_analysis_traceability_20260519.md`

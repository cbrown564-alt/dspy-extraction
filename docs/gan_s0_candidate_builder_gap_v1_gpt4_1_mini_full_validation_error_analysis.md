...
- Artifact directory: `runs\gan_s0_candidate_builder_gap_v1_gpt4_1_mini_full_validation_20260523T161524Z`
...
| --- | ---: | ---: | ---: |
| normalized_label | 67.2% | 201 | 299 |
| monthly_frequency | 75.9% | 227 | 299 |
| purist_category | 81.3% | 243 | 299 |
| pragmatic_category | 85.6% | 256 | 299 |
...
- Overall operational failure rate: 24.1% (72 failures)

| Stratum | All records | Valid scored | Operational failure rate | Monthly (valid only) |
| --- | ---: | ---: | ---: | ---: |
| hard_case=true | 39 | 39 | 20.5% | 79.5% |
| hard_case=false | 260 | 260 | 24.6% | 75.4% |
| row_ok=true | 287 | 287 | 25.1% | 74.9% |
| row_ok=false | 12 | 12 | 0.0% | 100.0% |
| gold_pragmatic=frequent | 152 | 152 | 29.6% | 70.4% |
| gold_pragmatic=infrequent | 51 | 51 | 39.2% | 60.8% |
...
| --- | --- | ---: | ---: |
| `1111` | all_four_match | 201 | 67.2% |
| `0111` | monthly_purist_pragmatic_not_normalized | 26 | 8.7% |
| `0001` | pragmatic_only | 13 | 4.3% |
| `0000` | all_four_wrong | 43 | 14.4% |
| `0011` | purist_pragmatic_not_monthly | 16 | 5.4% |

### Logical containment on this run

- Normalized exact (201 records): always co-occurs with monthly, Purist, and Pragmatic match.
- Monthly match (227 records): always implies Purist and Pragmatic; 201 also have normalized exact.
- Purist match (243 records): always implies Pragmatic; 227 also match monthly.
- Pragmatic-only wins (pattern `0001`): 13 records.
- Purist-without-monthly (pattern `0010`/`0011`): 0 + 16 records.

### Boundary cases

- **purist_bin_boundary_within_pragmatic**: 13
...
The leading benchmark-severe failure class on this run is `other_semantic_mismatch` (26 scored misses). These are the first prompt or verifier targets; lower-tier metric wins should not hide them.
...
There are 13 **pragmatic-only** successes: same coarse bucket (infrequent vs frequent vs unknown vs no information) but wrong monthly value and Purist bin. These are clinically misleading if only Pragmatic accuracy is reported.

Purist-without-monthly cases: 16; pragmatic-without-monthly: 29. These arise when different labels land in the same bin but convert to different seizures/month.
...
| gan_15129 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 4 per 15 month | 1 per 15 month |
...
| gan_16750 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 6 per 7 month | 3 per 8 month |
...
| gan_13058 | scored | N | N | N | N | frequent_overcalled | 2 per 7 month | 1 per 3 week |
...
| gan_16645 | scored | N | N | Y | Y | pragmatic_match_monthly_divergence | 5 per 7 month | 3 cluster per year, 1 per cluster |
...
| gan_16422 | scored | N | N | N | Y | purist_bin_boundary_within_pragmatic | 1 per 2 to 3 day | 1 to 2 per day |

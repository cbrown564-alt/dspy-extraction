...
| **S2** | S1 + investigation + comorbidity | Frozen v1.3 — `docs/exect_s2_field_expansion_design.md` |
...
| **S4** | Full ExECTv2-like schema | Seizure frequency, rich prescriptions, CUI-level reproduction — `docs/exect_gold_label_audit.md` |
...
- CUI-aware or annotation-reproduction probe — `docs/exect_gold_label_audit.md` “complex schema approach”
...
- `docs/exect_gold_label_audit.md` — entity sources, seizure-frequency warning
- `docs/exect_s2_label_policy_v1_3_implementation.md` — S2 freeze artifact
- `docs/kanban_plan.md` — Thread D active work

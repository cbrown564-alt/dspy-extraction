...
Prior reads: `docs/exect_s0_s1_validation_full_v4_1_inspection.md`, `docs/exect_s0_label_policy_v4_2_implementation.md`
...
Grounded in `docs/exect_gold_label_audit.md` and `exect-label-policy-alignment`: benchmark-facing annotated medication only; temporality not scored; `missing_gold` flags preserved; scorer unchanged.

...
Pre-registration: `docs/exect_s1_seizure_prompt_policy_qwen_preregistration_20260520.md`  
Implementation: `docs/exect_s0_label_policy_v4_11_implementation.md`  
Error analysis (baseline): `docs/exect_qwen_s1_seizure_gap_error_analysis_20260520.md`
...
- [x] Registry rows under `exect_s1_seizure_prompt_policy_qwen_v1` in `docs/experiment_registry.json`
- [x] Regenerate `docs/experiment_registry_matrix_20260520.md` after registry edit
- [x] Update `docs/kanban_plan.md` decisions table

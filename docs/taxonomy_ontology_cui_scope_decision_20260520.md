...
Related: `docs/taxonomy_primitives_workstream_plan_20260520.md`, `docs/published_benchmark_metrics.md`, `docs/exect_gold_label_audit.md`, Card 19 blocked benchmark pack
...
1. Local ExECT scoring remains **normalized string / CUIPhrase-surface** field-family diagnostics, as documented in `docs/published_benchmark_metrics.md`.
...
1. `docs/kanban_plan.md` explicitly schedules published ExECT Table 1 reproduction, and

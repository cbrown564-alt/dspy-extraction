...
Related decision: `docs/workstreams/hybrid/hybrid_component_taxonomy_decision_20260520.md`  
Related registry: `docs/experiments/synthesis/experiment_registry.json`
...
Rows in `docs/experiments/synthesis/experiment_registry.json` use one row per canonical experiment ID.
...
`docs/experiments/synthesis/experiment_registry.json`. Early stubs may set `taxonomy_exemption` to
...
See `docs/workstreams/hybrid/hybrid_pipeline_research_pivot_20260521.md`.
...
- `det_candidates_support_context_llm_target_selector`
...
| `reject` | Evidence argues against continuing **this arm** under current controls. Prefer `decision_scope: arm` in inspection docs. Mechanism-class closure requires a mechanism review (see `docs/workstreams/hybrid/hybrid_pipeline_research_pivot_20260521.md`). |

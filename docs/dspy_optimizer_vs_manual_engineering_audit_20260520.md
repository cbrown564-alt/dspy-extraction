...
Related: `docs/dspy_gepa_react_best_practices_deep_dive.md`, `docs/qwen_dspy_latency_policy.md`, `docs/gan_s0_temporal_candidate_pivot_20260519.md`, `docs/gan_s0_gepa_vs_synthesis_decision_20260519.md`, `docs/research_drift_audit_20260520.md`
...
- `docs/kanban_plan.md`, `docs/kanban_frozen_threads_history.md`, `docs/outline.md`
...
| GEPA | Prompt bloat (508→1,819 words on Qwen), label regression | Correctly deprioritized — see `docs/gan_s0_gepa_vs_synthesis_decision_20260519.md` |
...
Nothing. No `optimizer` block in any ExECT config. Qwen replication explicitly skips optimizers per `docs/qwen_dspy_latency_policy.md` and `docs/exect_qwen35b_ladder_replication_plan.md`.
...
Per `docs/qwen_dspy_latency_policy.md`:
...
- `docs/gan_s0_semantic_optimizer_cap25_followup_20260519.md`
- `docs/exect_section_aware_cap25_inspection.md`
- `docs/exect_s0_label_policy_v4_10_implementation.md`
...
See Kanban cards added under Backlog / Ready in `docs/kanban_plan.md` (2026-05-20 refresh):

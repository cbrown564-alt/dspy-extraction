...
Parent plan: `docs/hybrid_pipeline_exploration_implementation_plan_20260521.md` (item 18)  
Residual synthesis: `docs/exect_s4_residual_error_analysis_20260521.md`  
Prior H1 arm (reject): `docs/exect_s4_temporality_deterministic_gpt_inspection_20260520.md`  
...
See `docs/exect_s4_temporality_planned_taper_error_read_20260520.md`: taper-on-current policy is not the main failure mode.
...
2. Preregister `docs/exect_s4_medication_precision_guard_gpt_cap25_v1_preregistration_20260521.md`.

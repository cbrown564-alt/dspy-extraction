...
- `docs/exect_s0_s1_validation_cap25_inspection.md` (prior run `runs/exect_s0_s1_validation_cap25_gpt4_1_mini_20260518T172431Z`)
...
Grounded in `docs/exect_gold_label_audit.md`: benchmark-facing diagnosis/seizure/medication only; specificity collapse and `missing_gold` surfaced as flags, not scorer changes.

...
Related: `docs/taxonomy_primitives_workstream_plan_20260520.md`, `docs/hybrid_component_taxonomy_decision_20260520.md`, `docs/gan_s0_qwen35b_react_temporal_tools_regression_slice_guardrails_inspection_20260520.md`, `src/clinical_extraction/interleaving_adapters.py`
...
1. A pre-registered H3 comparison group is approved in `docs/kanban_plan.md`, or

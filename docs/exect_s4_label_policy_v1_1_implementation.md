...
S4 v1.0 full validation (`runs/exect_s4_validation_full_gpt4_1_mini_20260520T001602Z`) established the eleven-family ladder baseline at **63.4%** micro F1 but **seizure frequency F1 was 25.6%**. Error read: `docs/exect_s4_validation_full_gpt4_1_mini_inspection_20260520.md`.
...
**Freeze decision:** Record **S4 v1.1 full anchor** at `…064751Z`. Error read: `docs/exect_s4_validation_full_v1_1_gpt4_1_mini_inspection_20260520.md`. Optional v1.2: qualitative frequency co-labels + investigation `unknown` guard (S4-only).

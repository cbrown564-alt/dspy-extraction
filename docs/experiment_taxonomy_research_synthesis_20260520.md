...
Source decision: `docs/hybrid_component_taxonomy_decision_20260520.md`
...
Steps 1-7 of `docs/hybrid_component_taxonomy_decision_20260520.md` are now
implemented as repo artifacts:

- `docs/experiment_registry.json` seeds the canonical experiment registry with
  82 experiment rows, one per distinct metric-bearing experiment ID from local
  run artifacts.
- `docs/experiment_taxonomy_schema.md` defines controlled values and usage rules
...
Inspection: `docs/gan_s0_qwen35b_react_temporal_tools_regression_slice_guardrails_inspection_20260520.md`
...
- `docs/hybrid_component_taxonomy_decision_20260520.md`
- `docs/experiment_inventory_for_taxonomy_20260520.md`

...
**Freeze decision (2026-05-20):** S3 **frozen at v1.2** for ladder planning. Comorbidity gap **accepted**; no v1.3 comorbidity tuning on validation. Ladder continues at **S4** — see `docs/planning/kanban_plan.md` Thread E.

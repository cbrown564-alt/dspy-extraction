...
Prior docs: `docs/experiments/exect/exect_s0_s1_validation_full_inspection.md` (v3), `docs/experiments/exect/exect_s0_label_policy_regression_slice_comparison_20260519.md`
...
Grounded in `docs/datasets/exect/exect_gold_label_audit.md`: benchmark-facing fields only; deterministic bridges tagged in prediction `quality_flags`; v3 full run retained as historical comparison anchor.

...
see `docs/experiments/exect/exect_s2_s4_schema_ladder_design.md` and `docs/planning/kanban_plan.md` Thread E.

## Audit basis

- `docs/datasets/exect/exect_gold_label_audit.md` — Bug 1 (frequency ≠ seizure type), Bug 2 (no Rx temporality column), Q4 (multi-type frequency)
- `docs/experiments/exect/exect_s3_phase1_overlap_policy.md` — independent per-family scoring when phrases overlap
...
- `docs/experiments/exect/exect_s2_s4_schema_ladder_design.md`

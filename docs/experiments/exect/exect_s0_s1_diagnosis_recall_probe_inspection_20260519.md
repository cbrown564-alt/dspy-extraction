...
Grounded in `docs/datasets/exect/exect_gold_label_audit.md` and `exect-label-policy-alignment` skill: benchmark-facing labels only; add-only merge tagged via program variant metadata; scorer unchanged.

...
Preregistration: `docs/experiments/exect/exect_s1_seizure_prompt_policy_qwen_preregistration_20260520.md`  
...
Qwen full approved per amended cap-25 gate; full run `exect_s1_seizure_prompt_policy_v4_11_full_qwen35b_ollama_20260520T231850Z` — **Hold (promote blocked)** per `docs/experiments/exect/exect_s1_seizure_prompt_policy_qwen_v1_inspection_20260520.md`.
...
`docs/experiments/exect/exect_s0_label_policy_v4_10_implementation.md`, `docs/experiments/exect/exect_qwen_s1_seizure_gap_error_analysis_20260520.md`

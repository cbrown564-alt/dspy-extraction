...
The design follows `docs/datasets/exect/exect_gold_label_audit.md` by keeping seizure types tied to audited diagnosis-style labels, preserving diagnosis certainty/specificity behavior, and treating medication temporality and missing-gold limits as caveats rather than scorer changes.

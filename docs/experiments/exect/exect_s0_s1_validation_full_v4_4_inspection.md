...
Prior reads: `docs/experiments/exect/exect_s0_label_policy_v4_4_implementation.md`, `docs/experiments/exect/exect_s0_s1_validation_full_v4_2_medication_evidence_inspection.md`
...
See `docs/experiments/exect/exect_label_policy_prior_error_analysis_traceability_20260519.md` for canonical-case rationale (e.g. EA0016 single-event null diagnosis).
...
Grounded in `docs/datasets/exect/exect_gold_label_audit.md` and `exect-label-policy-alignment`: benchmark-facing field families only; `specificity_collapsed` and `missing_gold` flags preserved in reports; scorer unchanged.

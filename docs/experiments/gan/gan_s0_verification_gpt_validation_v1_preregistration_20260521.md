...
Date: 2026-05-21  
Status: **Cap-25 complete — hold (null factor)** — `docs/experiments/gan/gan_s0_lane_a_gpt_cap25_inspection_20260521.md`  
...
**Status (2026-05-21):** Reassigned to Axis 1 comparison group `gan_s0_pipeline_stage_graph_gpt_cap25_v1` as arm **A3** (`g2_candidates_adjudicate`). See `docs/experiments/gan/gan_s0_pipeline_stage_graph_gpt_cap25_v1_preregistration_20260521.md`. LLM candidate ID remains deferred to Phase 3 (`gan_s0_stage_executor_gpt_cap25_v1`).
...
- [ ] Regenerate `docs/experiments/synthesis/experiment_registry_matrix_20260520.md` and `docs/research_atlas/evidence_matrix.md`

...
- Inspection: `docs/experiments/gan/gan_s0_verify_repair_full_validation_v2_20260519.md`
...
- Gemini direct cap-25: `docs/experiments/gan/gan_s0_gemini31_flash_lite_cap25_inspection_20260519.md`
- Gemini verify-repair cap-25: `docs/experiments/gan/gan_s0_gemini31_flash_lite_verify_repair_cap25_inspection_20260519.md`
- Gemini full validation: `docs/experiments/gan/gan_s0_gemini31_flash_lite_full_validation_inspection_20260519.md`
...
- **Not comparable to local Qwen**: Ollama runs do not report billable tokens;
  cost is hardware time (see `docs/workstreams/optimizer/qwen_local_latency_experiment_20260518.md`).
...
- `docs/policies/model_config_smoke_tests.md` — one-record provider compatibility
- `docs/experiments/gan/gan_s0_gepa_vs_synthesis_decision_20260519.md` — GEPA pivot to verify-repair
- `docs/planning/kanban_plan.md` — active sequencing

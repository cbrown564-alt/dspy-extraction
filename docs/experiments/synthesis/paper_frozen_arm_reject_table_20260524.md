...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ExECT S5 per-family parallel ceiling (C-track C1) | ExECTv2 | `exect_s5_per_family_parallel_ceiling_gpt_cap25_v1` | `pipeline_stage_graph` | v2b single-pass cap-25 | pooled micro F1 | 83.6% (−4.6pp) | Five parallel family calls + v2b freq verifier regressed vs monolithic pass; seizure_type −11.9pp; evidence 91.5%; ~14× latency | `exect_s5_core_field_family_parallel_v2b_cap25_gpt4_1_mini_20260524T212052Z` | arm |
| ExECT S5 combined frequency verifier v2 (v1.3 + strict qualitative + v2 rules) | ExECTv2 | `exect_s5_frequency_pre_vocab_am_guard_frequency_verify_v1` cap-25 | `prompt_policy` + `verification_strategy` + `strict_qualitative` | v1 verifier cap-25 | seizure_frequency recall | 60.0% (−16.0pp) | Recall collapsed; v2b isolation shows v2 temporal rules alone are safe; abstention/guard stacking caused collapse | `exect_s5_frequency_pre_vocab_am_guard_frequency_verify_v2_cap25_gpt4_1_mini_20260524T205934Z` | arm |
...
| Item | Outcome | Notes |
| --- | --- | --- |
| ExECT S5 paper-frozen stack (v2b verifier) | **Promoted to D1** | 73.9% seizure_frequency F1, 85.8% micro F1 — run `exect_s5_frequency_pre_vocab_am_guard_frequency_verify_v2b_full_gpt4_1_mini_20260524T211229Z`; see [v2b promotion review](../exect/exect_s5_frequency_verifier_v2b_full_validation_promotion_review_20260524.md) |
| ExECT S5 v1 verifier + A3 stack | **Superseded D1** | 72.3% freq F1 — run `exect_s5_frequency_pre_vocab_am_guard_frequency_verify_full_gpt4_1_mini_20260524T195813Z` |

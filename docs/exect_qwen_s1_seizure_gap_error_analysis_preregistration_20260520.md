...
Decision source: `docs/kanban_plan.md`, `docs/exect_field_family_deterministic_support_map_20260520.md`, `docs/exect_negative_probe_synthesis_20260520.md`, `docs/taxonomy_primitive_catalog.md`  
...
`docs/exect_qwen_s1_seizure_gap_error_analysis_20260520.md`

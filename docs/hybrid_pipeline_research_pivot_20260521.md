...
- Ontology (unchanged): `docs/hybrid_component_taxonomy_decision_20260520.md`
- Prior snapshot (historical bets, not closure): `docs/hybrid_deterministic_placement_research_synthesis_20260521.md`
- Execution plan: `docs/hybrid_pipeline_exploration_implementation_plan_20260521.md`
- Agent skill: `.agents/skills/hybrid-pipeline-exploration/SKILL.md`
- Operating board: `docs/kanban_plan.md`
...
Listed in `docs/exect_negative_probe_synthesis_20260520.md` and Lane A / ladder inspections — **specific configs and comparison groups only**.
...
Execute Phase 0–1 in `docs/hybrid_pipeline_exploration_implementation_plan_20260521.md`: doctrine embedded (this doc, skill, Kanban), then **Gan S0 Axis 1 stage-graph** preregistration and config batch. Axis 2 candidate-source arms follow only after the Axis 1 inspection ranks the skeletons.

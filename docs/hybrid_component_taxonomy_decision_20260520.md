...
Related inventory: `docs/experiment_inventory_for_taxonomy_20260520.md`  
Related synthesis: `docs/experiments_methods_results_20260520.md`, `docs/dspy_optimizer_vs_manual_engineering_audit_20260520.md`, `docs/kanban_plan.md`
...
1. Create `docs/experiment_taxonomy_schema.md` with controlled values.

...
Primary sources: `docs/outline.md`, `docs/published_benchmark_metrics.md`, `docs/experiments_methods_results_20260520.md`, `docs/experiments_narrative_report_20260520.md`, `docs/research_atlas/evidence_matrix.md`, `docs/kanban_plan.md`
...
Published values are taken from `docs/published_benchmark_metrics.md`.

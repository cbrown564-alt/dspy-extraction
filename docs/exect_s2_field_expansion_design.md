...
- **Prompt:** `exect_s2_field_family_v1_2_label_policy` (v1.2 — comorbidity affirmed-history recall + S2-only bridges; see `docs/exect_s2_label_policy_v1_2_implementation.md`)
...
**v1.2 (current):** `runs/exect_s2_validation_cap25_gpt4_1_mini_20260519T225836Z` — 84.1% micro F1, comorbidity 74.3%, seizure 83.1%. See `docs/exect_s2_label_policy_v1_2_implementation.md`.

**v1.1:** `runs/exect_s2_validation_cap25_gpt4_1_mini_20260519T225159Z` — 79.7% micro F1, seizure 80.6%, comorbidity 53.8%. See `docs/exect_s2_label_policy_v1_1_implementation.md`.
...
**Read:** Contract gate passed (25/25 evaluated). Full error analysis: `docs/exect_s2_validation_cap25_gpt4_1_mini_inspection_20260519.md`.
...
**S2 frozen at v1.3.** Full anchor: `runs/exect_s2_validation_full_gpt4_1_mini_20260519T231223Z` (80.9% micro, 69.3% comorbidity). Schema ladder continues in **`docs/exect_s2_s4_schema_ladder_design.md`** and Thread D in `docs/kanban_plan.md`.

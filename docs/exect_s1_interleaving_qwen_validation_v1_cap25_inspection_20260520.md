...
**Full inspection (authoritative):** `docs/exect_s1_interleaving_qwen_validation_v1_inspection_20260520.md`  
...
1. ~~Run full-validation pair~~ — complete; see `docs/exect_s1_interleaving_qwen_validation_v1_inspection_20260520.md`.

...
Sources: four exploration passes, `configs/experiments/` (93 configs), local `runs/` (191 dirs, 162 with `metrics.json`, 80 unique `experiment_id`s), `docs/experiments_narrative_report_20260520.md`, frozen-thread history, inspection/decision docs.

**Not a taxonomy yet.** This document inventories what exists. Taxonomy candidates are in §8.

**Validity caveat:** All headline metrics use **repo synthetic splits** and **deterministic scorers** — not Gan Real(300) or full ExECT Table 1 (`docs/published_benchmark_metrics.md`).
...
- `docs/experiments_narrative_report_20260520.md`
- `docs/experiments_methods_results_20260520.md`

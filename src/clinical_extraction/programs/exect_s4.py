...
from clinical_extraction.exect.s5_stack import (
    ...
    apply_exect_s5_frequency_verifier_guards as _s5_apply_exect_s5_frequency_verifier_guards,
    ...
    qualitative_label_supported_by_evidence as _s5_qualitative_label_supported_by_evidence,
...
def _build_s5_core_parallel_field_values(
    ...
    *,
    ...
    return build_exect_s5_core_parallel_field_values(
        pred,
        record,
        program_variant=program_variant,
        recover_investigation_raw_values=_recover_s4_investigation_raw_values,
        recover_frequency_values=_recover_s4_seizure_frequency_values,
    )
...
def _predict_s5_core_parallel_record(
    ...
    *,
    ...
    return build_exect_s5_core_parallel_prediction(
        module,
        record,
        program_variant=program_variant,
        schema_level=schema_level,
...
def _recover_s4_seizure_frequency_values(
    ...
    *,
    ...
    allowed = verified_frequency_allowed_keys(raw_values)
...
def _apply_exect_s5_frequency_verifier_guards(
    *,
    ...
    return _s5_apply_exect_s5_frequency_verifier_guards(
        note_text=note_text,
        initial_frequency=initial_frequency,
        verified=verified,
        strict_qualitative=strict_qualitative,
    )


def _qualitative_label_supported_by_evidence(raw_value: str, evidence_text: str) -> bool:
    return _s5_qualitative_label_supported_by_evidence(raw_value, evidence_text)

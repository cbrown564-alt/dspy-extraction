...
$experiment = "configs/experiments/gan_s0_l2_qwen_exact_policy_full_qwen35b_ollama.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "gan_s0_l2_qwen_exact_policy_full_qwen35b_$timestamp.log"
...
Write-Log "Gan S0 Qwen35b L2.1 Exact Policy Full Validation run started"

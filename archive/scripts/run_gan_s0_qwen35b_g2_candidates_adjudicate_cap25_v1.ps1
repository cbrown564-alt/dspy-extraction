...
$experiment = "configs/experiments/gan_s0_qwen35b_g2_candidates_adjudicate_cap25_v1.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "gan_s0_qwen35b_g2_candidates_adjudicate_cap25_v1_$timestamp.log"
...
Write-Log "Gan S0 Qwen35b g2_candidates_adjudicate cap-25 run started"

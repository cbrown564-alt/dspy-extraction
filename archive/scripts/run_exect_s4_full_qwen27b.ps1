# Standalone ExECT S4 full validation (Qwen3.6:27b). Detached-friendly launcher with logging.
$ErrorActionPreference = "Stop"
$PSNativeCommandUseErrorActionPreference = $false
Set-Location "C:\Users\cbrow\Code\dspy-extraction"

$experiment = "configs/experiments/exect_s4_validation_full_qwen27b_ollama.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "exect_s4_full_qwen27b_$timestamp.log"
$pidPath = Join-Path $logDir "exect_s4_full_qwen27b_$timestamp.pid"
...
Write-Log "ExECT S4 full validation Qwen3.6:27b started"

...
$experiment = "configs/experiments/gan_s0_qwen35b_error_taxonomy_policy_cap25.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "gan_s0_qwen35b_error_taxonomy_policy_cap25_$timestamp.log"
...
Write-Log "Gan S0 Qwen35b Error Taxonomy Policy cap-25 run started"

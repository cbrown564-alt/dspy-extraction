# Standalone ExECT S1 v4.12 diagnosis-stabilized cap-25 (Qwen3.6:35b). Detached-friendly launcher with logging.
$ErrorActionPreference = "Stop"
$PSNativeCommandUseErrorActionPreference = $false
Set-Location "C:\Users\cbrow\Code\dspy-extraction"

$experiment = "configs/experiments/exect_s1_qwen_v4_12_diagnosis_stabilized_cap25_qwen35b_ollama.json"
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $PWD "runs\overnight_logs"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null
$logPath = Join-Path $logDir "exect_s1_qwen_v4_12_cap25_qwen35b_$timestamp.log"
$pidPath = Join-Path $logDir "exect_s1_qwen_v4_12_cap25_qwen35b_$timestamp.pid"
...
Write-Log "ExECT S1 v4.12 diagnosis-stabilized cap-25 Qwen3.6:35b started"
